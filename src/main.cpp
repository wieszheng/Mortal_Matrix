...
String version = "0.43";
char awtrix_server[16] = "154.8.177.173";
  ...
  if (!ignoreServer)
  {
    ...
    case 12:
    {
      ...
      if (ldrState != 0)
      {
        ...
        // 打印读数（这里打印的是电阻值，通常光强与电阻值成反比）
        // Serial.print("光敏电阻的阻值: ");
...
void setup()
{
  ...
  if (!wifiManager.autoConnect("Mortal Matrix", "12345678"))
  {
  ...
  // {
  //   // temp OK
  //   Serial.println("BMESensor.begin");
